...
class ProductAdapter extends CommonProductAdapter
{
    ...
    /** @var string UPC meta key */
    const PRODUCT_UPC_META_KEY = '_mwc_product_upc';

    /** @var string UPC meta key for compatibility with https://wordpress.org/plugins/ean-for-woocommerce */
    const PRODUCT_UPC_COMPAT_META_KEY = '_alg_ean';
