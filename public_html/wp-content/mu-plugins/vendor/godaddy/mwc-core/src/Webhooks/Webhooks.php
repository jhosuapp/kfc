...
class Webhooks implements ConditionalComponentContract
{
    ...
    {
        // @TODO this method should be updated to return `true` once we're ready to deploy {agibson 2024-05-23}
        return defined('GD_MWC_ENABLE_NEW_WEBHOOKS') && GD_MWC_ENABLE_NEW_WEBHOOKS;
    }
}
