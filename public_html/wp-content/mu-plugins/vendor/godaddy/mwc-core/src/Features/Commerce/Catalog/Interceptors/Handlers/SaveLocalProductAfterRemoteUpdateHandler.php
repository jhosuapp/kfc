...
use GoDaddy\WordPress\MWC\Core\Features\Commerce\Catalog\Services\UpdateLocalProductMetaDataService;
...
class SaveLocalProductAfterRemoteUpdateHandler extends AbstractInterceptorHandler
{
    ...
    protected UpdateLocalProductMetaDataService $updateLocalProductMetaDataService;
    ...
    public function __construct(
        ...
        UpdateLocalProductMetaDataService $updateLocalProductMetaDataService
    ) {
        $this->productsService = $productsService;
        $this->productBaseAdapter = $productBaseAdapter;
        $this->insertMissingAttachmentsService = $insertMissingAttachmentsService;
        $this->updateLocalProductMetaDataService = $updateLocalProductMetaDataService;
    }
    ...
    protected function makeCoreProduct(int $localProductId) : Product
    {
        ...
        $this->updateLocalProductMetaDataService->handle($localProductId, $remoteProduct);
